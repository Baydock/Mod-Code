...
namespace HelpfulAdditions {
    ...
    public class AddButtons_Patch {
        ...
        public static void Postfix(ref BloonMenu __instance) {
            ...
            Globals.destroyProjectilesButtons.Add(__instance.GetInstanceID(), destroyProjectilesButton);
    ...
    public class RemoveButtons_Patch {
        ...
        public static void Postfix(ref BloonMenu __instance) {
            ...
            GameObject projectileButton = Globals.destroyProjectilesButtons[instanceId];
            Object.Destroy(projectileButton);
            Globals.destroyProjectilesButtons.Remove(instanceId);
        }
    }
    ...
    public class UpdateButtons_Patch {
        ...
        public static void Postfix(ref BloonMenu __instance) {
            ...
            if (Globals.destroyProjectilesButtons.ContainsKey(instanceId))
                Globals.destroyProjectilesButtons[instanceId].transform.position = destroyProjectilesPos;
        }
    }
}
